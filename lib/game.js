...
class PlayGame {
  ...
  resetGhostPositions() {
    this.greenGhost.pos = [2, 14];
    this.greenGhost.nextPos = [2, 14];
    this.redGhost.pos = [2, 2];
    this.redGhost.nextPos = [2, 2];
    this.pinkGhost.pos = [12, 2];
    this.pinkGhost.nextPos = [12, 2];
    this.yellowGhost.pos = [16, 24];
    this.yellowGhost.nextPos = [16, 24];
    this.greenGhost.canvasY = 40;
    this.greenGhost.canvasX = 280;
    this.redGhost.canvasY = 40;
    this.redGhost.canvasX = 40;
    this.yellowGhost.canvasY = 320;
    this.yellowGhost.canvasX = 480;
    this.pinkGhost.canvasY = 240;
    this.pinkGhost.canvasX = 40;
    this.greenGhost.counter = 0;
    this.redGhost.counter = 0;
    this.yellowGhost.counter = 0;
    this.pinkGhost.counter = 0;
    this.redGhost.resetNextPos = true;
    this.greenGhost.resetNextPos = true;
    this.yellowGhost.resetNextPos = true;
    this.pinkGhost.resetNextPos = true;
  }
